...
<head>
    ...
    <style>
        ...
        body { 
            ...
            background: #f8fafc;
            background-image: 
                radial-gradient(at 0% 100%, rgba(250, 204, 21, 0.08) 0px, transparent 50%),
    ...
    <div class="auth-card">
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" placeholder="operator@domain.com" required>
        ...
        <div class="footer-links">
            Already registered? <a href="{{ route('login') }}" class="link">Access Portal</a>
        </div>
    </div>
</body>
</html>